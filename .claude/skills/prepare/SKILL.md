...
- `.agent/skills/search-tools/references/known-mcps.md` — Available MCP servers
- `.agent/skills/build/references/conventions.md` — Coding conventions quick reference
...
- Reference: `.agent/skills/search-tools/references/known-mcps.md` for available MCPs
...
Write build briefs to `pipeline/5.5-prepare/brief-{spec-id}-YYYY-MM-DD.md` using the template at `templates/build-brief.md`.

If preparing a wave, also write a wave summary to `pipeline/5.5-prepare/wave-{N}-YYYY-MM-DD.md`.
