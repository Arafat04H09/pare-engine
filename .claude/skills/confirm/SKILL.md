...
You are performing semantic verification of a completed build spec for Pare Engine.

## Inputs

A spec file path should be provided: $ARGUMENTS
...
Write to `pipeline/7-confirm/confirm-YYYY-MM-DD.md` using the template at [templates/verification-report.md](templates/verification-report.md).
